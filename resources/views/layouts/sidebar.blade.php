         ...
         <nav class="sidebar-main">
             ...
             <div id="sidebar-menu">
                 <ul class="sidebar-links" id="simple-bar">
                     ...
                     <li class="sidebar-list">
                         <a class="sidebar-link sidebar-title link-nav" href="{{ route('admin.doctors.index') }}">
                             <svg class="stroke-icon">
                     ...
                     <li class="sidebar-list">
                         <a class="sidebar-link sidebar-title link-nav" href="{{ route('admin.doctor-documents.index') }}">
                             <svg class="stroke-icon">
                     ...
                     <li class="sidebar-list">
                         <a class="sidebar-link sidebar-title link-nav" href="{{ route('admin.consultations.index') }}">
                             <svg class="stroke-icon">
                     ...
                     <li class="sidebar-list">
                         <a class="sidebar-link sidebar-title link-nav" href="{{ route('admin.appointments.index') }}">
                             <svg class="stroke-icon">
                     ...
                     <li class="sidebar-list">
                         <a class="sidebar-link sidebar-title link-nav" href="{{ route('admin.sla.index') }}">
                             <svg class="stroke-icon">
